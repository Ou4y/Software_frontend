...
<?php include('../includes/header.php'); ?>
                ...
                <p class="product-description"><?php echo htmlspecialchars($att['attribute_value']); ?></p>
                        ...
                        <div>
                            ...
                            <div class="pd-color-list">
                                <div class="pd-color-item pd-active" style="background-color: #000000;" title="Black"></div>
                        ...
                        <div>
                            ...
                            <div class="pd-size-list">
                                <div class="pd-size-item">S</div>
                                <div class="pd-size-item pd-active">M</div>
                                <div class="pd-size-item">L</div>
                        ...
                        <div class="pd-cart-section">
                            ...
                            <button class="pd-add-cart-btn" onclick="pdAddToCart()">
    ...
    <div class="pd-notification" id="pdNotification">
        <i class="fas fa-check-circle"></i>
