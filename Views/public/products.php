...
$type = isset($_GET['type']) ? $_GET['type'] : 'MEN';  // Default to MEN if not set

$productController = new CategoryProductController();

switch ($type) {
    case 'MEN':
        $products = $productController->getMenProducts();
        break;
    case 'WOMEN':
        $products = $productController->getWomenProducts();
        break;
    case 'SPORTWEAR':
        $products = $productController->getSportswearProducts();
        break;
    case 'UNISEX':
        $products = $productController->getUnisexProducts();
        break;
    default:
        $products = [];
        break;
...
<div class="filter">
<h1 id="tit"><strong><?php echo ucfirst($type); ?>:</strong></h1>
